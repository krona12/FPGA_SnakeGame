...
xst -ifn xst.scr
move pll2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll2_exdes.ucf pll2_exdes

echo 'Running map'
map -timing -pr b pll2_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pll2_exdes -w routed.ncd routed.v
cd ..
